 ...
 */
//Loxovfkapsome (Mercator) Destination the WGS ellipsoid
//http://koti.mbnet.fi/jukaukor/loxovfkapsom.html
/**
 * To find the lat/lon of a point on true course brng, distance dist from (lat1,lon1)
 * along a rhumbline (initial point cannot be a pole!):
 *
...
*/
bool destLoxovfkapsome(double lat1, double lon1, double brng, double dist, double* lat2, double* lon2) {
